...
def build_intervention_prompt(
    ...
    prompt = (
        ...
        f"2.  **ИЗБЕГАЙ ШАБЛОННОСТИ:** Старайся не начинать свои реплики одинаково или слишком предсказуемо (например, шалоны, которые не стоит использовать: 'ага', 'классика жанра', 'серьезно?' и тд.). Будь разнообразнее!\n"
