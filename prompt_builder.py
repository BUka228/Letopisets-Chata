...
def build_intervention_prompt(
    ...
    prompt = (
        ...
        f"2.  **ИЗБЕГАЙ ШАБЛОННОСТИ:** Старайся не начинать свои реплики одинаково или слишком предсказуемо (шалоны, которые особенно не используй: 'ага', 'классика жанра', 'серьезно?' и тд.). Будь разнообразнее!\n"
