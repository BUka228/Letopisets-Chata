...
# Пределы
INTERVENTION_MIN_COOLDOWN_MIN = 15      # Минимальный кулдаун - 15 минут (доступно владельцу)
INTERVENTION_MAX_COOLDOWN_MIN = 480     # Максимальный кулдаун - 8 часов (был 1 неделя)
INTERVENTION_MIN_MIN_MSGS = 3           # Минимум 3 сообщения для реакции (доступно владельцу)
INTERVENTION_MAX_MIN_MSGS = 50          # Максимум 50 сообщений (оставим)
INTERVENTION_MIN_TIMESPAN_MIN = 5       # Минимальное окно проверки - 5 минут (без изменений)
INTERVENTION_MAX_TIMESPAN_MIN = 120     # Максимальное окно проверки - 2 часа (без изменений)

# Значения по умолчанию (если в БД NULL)
INTERVENTION_DEFAULT_COOLDOWN_MIN = 120 # Стандартно 2 часа (было 3 часа)
INTERVENTION_DEFAULT_MIN_MSGS = 10      # Стандартно 10 сообщений (было 5)
INTERVENTION_DEFAULT_TIMESPAN_MIN = 15  # Стандартно 15 минут (без изменений)

# Другие настройки вмешательств
INTERVENTION_PROMPT_MESSAGE_COUNT = 25 # Сколько последних сообщ. давать ИИ
